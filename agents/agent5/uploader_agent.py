...
def initialize_upload(youtube, options):
    ...
    body = dict(
        ...
        status=dict(
            ...
            selfDeclaredMadeForKids=not options.not_made_for_kids
        )
    )
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--not-made-for-kids", action="store_true", help="Specify that the video is NOT made for kids")
...
# uv run agents/agent5/uploader_agent.py \
#   --file="output/final_videos/video_output_1744020313.798982.mp4" \
